...
//        self.loadADUrl()
    ...
    func pushFilterVC(_ type:ScoreDetailVC){
        ...
        fileterSegment.filterSegmentViewControllerReloadDataClouse = {
            NotificationCenter.default.post(name: NSNotification.Name.init(type == .football ? RELOADFILTERFOOTBALLMODEL : RELOADFILTERBASKETBALLMODEL), object: nil, userInfo: nil)
        }
